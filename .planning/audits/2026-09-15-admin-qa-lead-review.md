...
| **QA-03** | P1 | SECURITY | F-07 no rate limiting on `/api/auth/login` | 12×401, no 429 | **[IMPLEMENTED — NOT VERIFIED]** (`d0cfc248`, 2026-09-21). DB-backed sliding window (`check_and_record_auth_attempt`, migration `20260921000000`) by email (5/15min) and IP (20/15min), fails open on RPC error. Migration not yet applied to production — `node scripts/checks/probe-auth-hardening.mjs` still shows `401×8`, no `429`. Runbook: `.planning/tasks/2026-09-21-f07-f08-apply-and-verify.md` |
