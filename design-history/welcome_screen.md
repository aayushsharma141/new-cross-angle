...
| **#4** (Active) | `checkpoint/v4-full-hybrid`  | `HEAD`             | **Active Full Hybrid Layout:** Combines the immersive Zen Step 0 Hero & single-row high-contrast stats with the full-length scrollable landing page sections (Five-input `AnimatedBeam` nodes, Literary quote, Archetypes cards, and Bottom interior background CTA with backdrop-blurs). Steps 1 & 2 render as clean fullscreen focused overlays. | [View Active Screenshot](file:///C:/Users/aayus/.gemini/antigravity-ide/brain/a6a439f8-f3f3-41f3-beb4-bb395aaefa4d/.tempmediaStorage/media_a6a439f8-f3f3-41f3-beb4-bb395aaefa4d_1779894073503.png) |
