...
CREATE INDEX IF NOT EXISTS idx_page_sections_content_json_gin ON public.page_sections USING gin (content_json);
-- Ensure blogs.content_json has a GIN index for full-text / structural search within rich text
CREATE INDEX IF NOT EXISTS idx_blogs_content_json_gin ON public.blogs USING gin (content_json);
