    ...
    return (
        <ModuleLayout
            ...
            tabs={[
                ...
                { label: "Transformations", path: "/admin/cms/transformations" },
                ...
                { label: "About Stats", path: "/admin/cms/stats" },
                { label: "Timeline Milestones", path: "/admin/cms/milestones" },
                { label: "Process Steps", path: "/admin/cms/process" },
            ]}
        >
            <Outlet />
        </ModuleLayout>
