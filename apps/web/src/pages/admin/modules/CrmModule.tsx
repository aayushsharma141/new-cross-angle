...
export const CrmModule = () => {
  ...
  return (
    <ModuleLayout
      title="Lead Operations Center"
      description="Track leads, manage follow-ups, and monitor deal health across your pipeline."
      tabs={[
        { label: "Pipeline Board", path: "/admin/crm/leads" },
