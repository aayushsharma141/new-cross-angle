...
const PrivacyPage = () => {
  return (
    <div className="min-h-screen bg-[#080808] text-white selection:bg-[#D4AF37]/30">
      <Helmet>
      ...
      <main id="main-content" className="pt-32 pb-24 relative z-10 overflow-hidden">
        ...
        <div className="pointer-events-none absolute top-0 inset-x-0 h-[500px] bg-gradient-to-b from-[#D4AF37]/8 to-transparent -z-10" />
        <div className="pointer-events-none absolute top-24 right-0 w-[600px] h-[600px] bg-[#D4AF37]/4 rounded-full blur-[140px] -z-10" />
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mb-14">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/20 text-[#D4AF37] mb-5 text-xs font-semibold uppercase tracking-widest">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="space-y-1.5 text-sm text-white/60">
                    <li className="flex gap-2"><span className="text-[#D4AF37] mt-0.5">•</span><span><strong className="text-white/80">Identity & Contact:</strong> Legal name, phone, email, and physical address.</span></li>
                    <li className="flex gap-2"><span className="text-[#D4AF37] mt-0.5">•</span><span><strong className="text-white/80">Project Specifics:</strong> Site location, floor plans, site photographs, and design preferences.</span></li>
                    <li className="flex gap-2"><span className="text-[#D4AF37] mt-0.5">•</span><span><strong className="text-white/80">Financial Information:</strong> PAN (for high-value transactions), GST details (commercial projects), and transaction history.</span></li>
                  </ul>
                </div>
                <div>
                  <p className="text-xs font-bold uppercase tracking-widest text-white/50 mb-2">B. Automatically Collected (Technical)</p>
                  <ul className="space-y-1.5 text-sm text-white/60">
                    <li className="flex gap-2"><span className="text-[#D4AF37] mt-0.5">•</span><span><strong className="text-white/80">Identifiers:</strong> IP addresses, browser type, and operating system.</span></li>
                    <li className="flex gap-2"><span className="text-[#D4AF37] mt-0.5">•</span><span><strong className="text-white/80">Usage Data:</strong> Clickstream patterns, time on pages, and referring URLs.</span></li>
                    <li className="flex gap-2"><span className="text-[#D4AF37] mt-0.5">•</span><span><strong className="text-white/80">Cookies:</strong> Essential cookies for session integrity and analytics cookies for site improvement.</span></li>
                  </ul>
                </div>
              </div>
            </Section>
                  ...
                  <div key={label} className="flex items-start gap-4 bg-black/30 border border-white/[0.06] rounded-xl p-4">
                    ...
                    <div>
                      <div className="flex flex-wrap items-center gap-2 mb-1">
                        ...
                        <span className="text-xs px-2 py-0.5 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/20 text-[#D4AF37] font-medium">{period}</span>
                      </div>
            ...
            <Section icon={Lock} title="6. Data Security & Third-Party Disclosure" index={5}>
              <div className="space-y-5">
                <div>
                  ...
                  <ul className="space-y-1.5 text-sm text-white/60">
                    <li className="flex gap-2"><span className="text-[#D4AF37]">•</span><span><strong className="text-white/80">Encryption:</strong> SSL/TLS encryption for all data in transit.</span></li>
                    <li className="flex gap-2"><span className="text-[#D4AF37]">•</span><span><strong className="text-white/80">Access Control:</strong> Strict Role-Based Access Control (RBAC) for internal staff.</span></li>
                    <li className="flex gap-2"><span className="text-[#D4AF37]">•</span><span><strong className="text-white/80">Vendor Due Diligence:</strong> Data shared only with DPDPA-compliant partners (Godrej, Philips, Hettich, Jaquar).</span></li>
                  </ul>
                </div>
            ...
            <Section icon={AlertTriangle} title="7. Grievance Redressal & Data Protection Officer" index={6}>
              ...
              <div className="bg-[#D4AF37]/5 border border-[#D4AF37]/15 rounded-xl p-4">
                <p className="text-xs font-bold uppercase tracking-widest text-[#D4AF37] mb-2">Breach Notification</p>
              ...
              <div className="mt-6 pt-5 border-t border-white/[0.07]">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white text-black text-sm font-semibold hover:bg-[#D4AF37] hover:text-white transition-all duration-200"
                >
