...
export function HeroPattern({
  ...
  if (variant === "manifesto") {
    return (
      <Section spacing="xl" className={cn("bg-canvas-primary text-content-primary py-24 lg:py-36", className)}>
        <Container size="narrow">
          <div className="text-center space-y-8">
            {badge && <Badge intent="copper" className="mx-auto font-mono text-xs">{badge}</Badge>}
  ...
  if (variant === "split") {
    return (
      <Section spacing="lg" className={cn("py-16 lg:py-24", className)}>
        <Container size="standard">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6">
              {badge && <Badge intent="copper" className="font-mono text-xs">{badge}</Badge>}
  ...
  return (
    <Section spacing="xl" className={cn("py-20 lg:py-32 bg-canvas-primary border-b border-subtle", className)}>
      <Container size="standard">
