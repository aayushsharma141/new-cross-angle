...
import { SparklesCore } from "@/components/ui/enhanced/sparkles";
...
export const Compare = ({
    ...
    return (
        ...
        >
                    ...
                    {firstImage ? (
                        ...
                        >
                            ...
                            <div className="absolute bottom-4 left-4 z-30 pointer-events-none">
                                <span className="bg-black/50 text-white text-xs font-medium md:text-sm px-3 py-1.5 rounded-lg backdrop-blur-sm shadow-sm ring-1 ring-white/20">
                                    Before
                                </span>
                            </div>
                        </motion.div>
            ...
            {/* After Label */}
            {secondImage && (
                <div className="absolute bottom-4 right-4 z-[19] pointer-events-none">
                    <span className="bg-black/50 text-white text-xs font-medium md:text-sm px-3 py-1.5 rounded-lg backdrop-blur-sm shadow-sm ring-1 ring-white/20">
                        After
                    </span>
                </div>
