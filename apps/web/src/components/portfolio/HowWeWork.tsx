...
const HowWeWork = () => {
  return (
    <section className="bg-[#050505] py-24 border-t border-white/5 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[400px] bg-primary/5 blur-[120px] pointer-events-none" />
        ...
        <div className="text-center mb-20">
          ...
          >
            <div className="flex items-center justify-center gap-4 mb-4">
              ...
              <span className="text-primary font-bold uppercase tracking-[0.3em] text-[10px]">The Process</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4 max-w-5xl mx-auto">
          {STEPS.map((step, index) => (
            <motion.div
              ...
              className="relative p-8 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-primary/30 hover:bg-white/[0.04] transition-all duration-500 group"
            >
              <div className="text-6xl font-extralight text-white/5 absolute right-6 top-6 group-hover:text-primary/10 transition-colors duration-500 pointer-events-none select-none">
                {step.number}
              </div>
              <div className="w-14 h-14 rounded-full bg-neutral-900 border border-white/10 flex items-center justify-center mb-8 group-hover:border-primary/50 group-hover:bg-primary/10 transition-all duration-500">
                {step.icon}
              </div>
              <h3 className="text-2xl font-serif text-white mb-4 group-hover:text-primary transition-colors duration-500">
                {step.title}
              </h3>
