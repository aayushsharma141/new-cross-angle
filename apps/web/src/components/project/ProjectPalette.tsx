...
const mockSwatchesData: Record<string, Swatch[]> = {
  ...
  "executive-workspace": [
    ...
    { name: "Biophilic Moss Wall", type: "Focal Panel", whyChosen: "Acts as a visual stress reducer while cleaning and balancing air levels.", durability: "Preserved natural mountain moss requiring zero light/soil feeding.", maintenance: "Self-sustaining, avoid direct water sprays.", img: "https://iuuivmwqodefdrrrewol.supabase.co/storage/v1/object/public/media/projects/discovery/visual-18.jpg" }
  ]
};
