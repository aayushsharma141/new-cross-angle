...
export function AdjectivesEditor() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-[10px] text-[hsl(var(--admin-text-muted))] mt-0.5">
            Style words shown in Step 4 of the Discovery quiz — users select up to 3
          </p>
        </div>
        <Button
          size="sm"
      ...
      {/* Chip cloud */}
      <div className="rounded-xl border border-[hsl(var(--admin-border))] bg-[hsl(var(--admin-card))] p-4 min-h-[80px]">
        {items.length === 0 ? (
