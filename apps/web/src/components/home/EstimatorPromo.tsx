              ...
              <div className="space-y-4 mb-10">
                {[
                  ...
                  <div key={idx} className="flex items-start gap-3 text-sm text-white/70 font-light">
                    <Check className="w-4 h-4 text-site-crimson mt-1 shrink-0" />
                    <span>{item}</span>
                  </div>
                ))}
              </div>
          ...
          <div className="lg:col-span-6">
            <ScrollReveal animation="slide-in-right" delay={0.2}>
              <div className="relative p-6 md:p-8 rounded-2xl bg-[#0a0a09] border border-white/[0.08] shadow-2xl relative overflow-hidden group">
                ...
                <div className="absolute top-0 right-0 w-32 h-32 bg-site-crimson/10 rounded-full blur-[40px] pointer-events-none" />
                
                {/* Header info */}
                <div className="flex items-center gap-4 mb-8 border-b border-white/5 pb-5">
                  <div className="w-12 h-12 rounded-xl bg-site-gold/10 border border-site-gold/20 flex items-center justify-center">
                    <Calculator className="w-6 h-6 text-site-gold animate-pulse" />
                  </div>
                  <div>
                ...
                <div className="space-y-6 mb-8">
                  <div>
                    ...
                    <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                      <div className="h-full w-[70%] bg-site-gold rounded-full" />
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-xs text-site-crimson font-mono font-medium">Luxury Finish</span>
                    </div>
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      <div className="py-2 text-center text-[10px] uppercase font-semibold border border-site-crimson bg-site-crimson/5 text-white cursor-default">Luxury</div>
                  ...
                  <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.04] flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-xs font-semibold text-white/80 flex items-center gap-1.5 justify-end">
                        <ShieldCheck className="w-3.5 h-3.5 text-site-crimson" /> 45 Days
                      </span>
                    </div>
                  </div>
                </div>
