...
import { OrbitingCircles } from "@/components/ui/enhanced/orbiting-circles";
import { cn } from "@/lib/utils";

export function DesignProcessVisual() {
  return (
    <div className="relative flex h-[600px] w-full flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden">
        <span className="text-[12rem] md:text-[20rem] font-serif font-black text-white/[0.03] uppercase tracking-tighter leading-none">
          Process
        </span>
      </div>
      ...
      {/* Orbiting Elements - Layered for depth */}
      <div className="absolute inset-0 z-10">
        {/* Inner Orbit */}
        <OrbitingCircles iconSize={32} radius={110} duration={25} delay={0}>
          <IconWrapper color="blue"><Icons.googleDrive /></IconWrapper>
        </OrbitingCircles>
        <OrbitingCircles iconSize={32} radius={110} duration={25} delay={8}>
          <IconWrapper color="green"><Icons.notion /></IconWrapper>
        </OrbitingCircles>
        <OrbitingCircles iconSize={32} radius={110} duration={25} delay={16}>
          <IconWrapper color="crimson"><Icons.whatsapp /></IconWrapper>
        </OrbitingCircles>

        {/* Outer Orbit - Reverse */}
        <OrbitingCircles iconSize={40} radius={190} duration={40} delay={0} reverse>
          <IconWrapper color="white" className="p-3"><Icons.openai /></IconWrapper>
        </OrbitingCircles>
        <OrbitingCircles iconSize={40} radius={190} duration={40} delay={10} reverse>
          <IconWrapper color="white" className="p-3"><Icons.notion /></IconWrapper>
        </OrbitingCircles>
        <OrbitingCircles iconSize={40} radius={190} duration={40} delay={20} reverse>
          <IconWrapper color="blue" className="p-3"><Icons.googleDrive /></IconWrapper>
        </OrbitingCircles>
        <OrbitingCircles iconSize={40} radius={190} duration={40} delay={30} reverse>
          <IconWrapper color="crimson" className="p-3"><Icons.whatsapp /></IconWrapper>
        </OrbitingCircles>
      </div>

      {/* Decorative floating lines / particles if needed */}
    </div>
  )
}
...
function IconWrapper({ children, color, className }: { children: React.ReactNode, color: string, className?: string }) {
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        "absolute -inset-1 rounded-full blur-md opacity-0 group-hover:opacity-40 transition-opacity duration-300",
