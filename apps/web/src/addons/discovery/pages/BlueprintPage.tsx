...
export default function BlueprintPage() {
  ...
  return (
    <div className="blueprint-page-wrapper bg-[#040404] text-[#E0E0E0] min-h-screen" ref={containerRef}>
      ...
      <div
        style={{ position: 'fixed', top: 0, left: 0, height: 2, width: `${scrollProgress}%`, background: 'linear-gradient(90deg,#D1AF6E,#C41230)', zIndex: 9997, transition: 'width 0.1s linear', boxShadow: '0 0 12px #D1AF6E' }}
      />
        ...
        <>
          ...
          <section id="journey-timeline" className="py-24 md:py-32 px-[4vw] max-w-[1600px] mx-auto border-b border-neutral-900">
            ...
            <div className="relative">
              ...
              <div className="absolute left-[19px] md:left-[23px] top-0 bottom-0 w-px bg-gradient-to-b from-[#C41230]/60 via-neutral-800 to-transparent pointer-events-none" />
